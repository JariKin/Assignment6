...
public class ListAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = inflater.inflate(R.layout.person_listview, null, true);
        ...
        holder.tvdate.setText("Date: "+dataModelArrayList.get(position).getDate());
    ...
    private class ViewHolder {
        ...
        protected TextView tvname, tvdate;
    }
}